          ...
          <Card>
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground mb-4">
                Tất cả các yêu cầu API phải được xác thực bằng API key. Bạn có thể tạo và quản lý API keys trong tab
                "API Keys".
              </p>
                ...
                <div>
                  ...
                  <div className="bg-muted p-4 rounded-md relative">
                    <pre className="text-sm overflow-x-auto">
                      {language === "curl" &&
                        `curl -X GET "https://api.metabot.vn/${version}/customers" \\
                  ...
                  <AccordionContent>
                    <div className="space-y-4">
                      ...
                      <div className="bg-muted p-4 rounded-md relative">
                        <pre className="text-sm overflow-x-auto">
                          {language === "curl" &&
                            `curl -X GET "https://api.metabot.vn/${version}/customers?limit=10&page=1" \\
  -H "Authorization: Bearer YOUR_API_KEY"`}
                          {language === "javascript" &&
                  ...
                  <AccordionContent>
                    <div className="space-y-4">
                      ...
                      <div className="bg-muted p-4 rounded-md relative">
                        <pre className="text-sm overflow-x-auto">
                          {language === "curl" &&
                            `curl -X GET "https://api.metabot.vn/${version}/customers/cust_123456" \\
  -H "Authorization: Bearer YOUR_API_KEY"`}
                          {language === "javascript" &&
...
?>`,
        ...
        <TabsContent value="conversations" className="space-y-4 pt-4">
          <Card>
            <CardContent className="pt-6">
              <h3 className="text-lg font-medium mb-2">API Cuộc hội thoại</h3>
              <p className="text-muted-foreground mb-4">
                API Cuộc hội thoại cho phép bạn quản lý và truy vấn các cuộc hội thoại trong Metabot.
              </p>
        ...
        <TabsContent value="campaigns" className="space-y-4 pt-4">
          <Card>
            <CardContent className="pt-6">
              <h3 className="text-lg font-medium mb-2">API Chiến dịch</h3>
              <p className="text-muted-foreground mb-4">
                API Chiến dịch cho phép bạn tạo và quản lý các chiến dịch marketing trong Metabot.
              </p>
